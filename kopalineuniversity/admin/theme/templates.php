...
<body >
   ...
   <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top  " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <img src="<?php echo web_root; ?>img/omt.jpg" height="23">
              Online Kopaline Student Management System</a>
            </div>
            <!-- /.navbar-header -->
   ...
   <!-- /input-group -->
                      ...
                      <?php if ($_SESSION['ACCOUNT_TYPE']=='Administrator') {  ?>
                      <li>
                             <a href="<?php echo web_root; ?>admin/lecturer/index.php" ><i class="fa fa-users fa-fw"></i> Manage Lecturer  </a>
