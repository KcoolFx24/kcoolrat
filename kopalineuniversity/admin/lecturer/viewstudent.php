...
if($userid=="" or $sectionid=="" or $subjectid==""){
  ...
  $sql ="SELECT * FROM  useraccounts u, tblsection sec, `tbllecturersubject` i,`subject` s, `course` c
...
?> 
 ...
 <h2 class="page-header"> <small>Lecturer Name: </small><?php echo $res->ACCOUNT_NAME; ?></h2>
